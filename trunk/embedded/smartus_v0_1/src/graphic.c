...
//Notes:
//==============
// => La notation X et Y ne semble pas très constante...
// => Si on dépasse de l'écran, ça revient de l'autre côté, il faudrait protéger
// => La routine de cercle est à refaire
...
//Trace une ligne entre 2 coordonnées
